...
ecalvalidation = cms.EDAnalyzer("EcalValidationDigiless_ES",
...
#    recHitCollection_ES       = cms.InputTag("ecalPreshowerRecHit","EcalRecHitsES"),
    recHitCollection_ES       = cms.InputTag("reducedEcalRecHitsES"),
    ...
    basicClusterCollection_ES = cms.InputTag("particleFlowSuperClusterECAL","particleFlowBasicClusterECALPreshower"),
    ...
    elePFlow = cms.InputTag("gedGsfElectrons"),
    elePFlowCand = cms.InputTag("particleFlow"),

    esPFRec  = cms.InputTag("particleFlowRecHitPS","Cleaned"),
